...
# 데이터 불러오기
f_ds = np.load('C:/nmb/nmb_data/npy/F_data_spectral_contrast.npy')
f_lb = np.load('C:/nmb/nmb_data/npy/F_label_spectral_contrast.npy')
m_ds = np.load('C:/nmb/nmb_data/npy/M_data_spectral_contrast.npy')
m_lb = np.load('C:/nmb/nmb_data/npy/M_label_spectral_contrast.npy')
# (1073, 128, 862)
# (1073,)
...
mcpath = 'C:/nmb/nmb_data/h5/conv1_model_01_spectral_contrast.h5'
...
# --------------------------------------
# 평가, 예측
model.load_weights('C:/nmb/nmb_data/h5/conv1_model_01_spectral_contrast.h5')
...
for file in files:   
    ...
    spectral_contrast = librosa.feature.spectral_contrast(y, sr = sr, n_fft = 512, hop_length=128)
    # pred_spectral_contrast = librosa.amplitude_to_db(spectral_contrast, ref=np.max)
    pred_spectral_contrast = spectral_contrast.reshape(1, spectral_contrast.shape[0], spectral_contrast.shape[1])
    y_pred = model.predict(pred_spectral_contrast)
    # print(y_pred)
