...
# def apply_phaseshuffle(args): # phase 셔플
#   x, rad = args
#   pad_type = 'reflect'
#   b, x_len, nch = x.get_shape().as_list()
#   phase = random.uniform([], minval=-rad, maxval=rad + 1, dtype=int32) # 범위 사이에서 실수 하나를 리턴함
...
def discriminator(architecture_size='audio_size',
    ...
    label_em = Embedding(n_classes, n_classes * 20)(label_input) # 양수형태로 들어온 정보를 벡터형태로 바꾼다
