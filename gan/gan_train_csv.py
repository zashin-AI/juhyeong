...
def train_model(sampling_rate = 22050,
    ...
    Args:
        ...
        architecture_size (str) = size of the wavegan architecture. Eeach size processes the following number 
            of audio samples: 'small' = 16384, 'medium' = 32768, 'audio_size' = 65536"
    ...
    #build the gan
    gan = gan_class_csv.WGANGP(latent_dim=latent_dim, discriminator=discriminator, generator=generator,
...
if __name__ == '__main__':
    train_model(sampling_rate = 22050,
                ...
                architecture_size = 'audio_size',
                path_to_weights = 'model_weights2.h5',
                resume_training = False,
