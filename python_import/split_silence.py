...
audio_dir = 'c:/nmb/nmb_data/STT/midslab/down/'
split_dir = 'c:/nmb/nmb_data/chunk/test_speed_up/'
sum_dir = 'c:/nmb/nmb_data/chunk/'

split_silence(audio_dir, split_dir, sum_dir)